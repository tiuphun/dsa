...
Compute the subset of orders that the boss accepts such that to total revenue is maximal and the rent periods of two orders cannot overlap (two periods cannot have common days)
Input
